/**
 * PixIcon — símbolo oficial do Pix (Banco Central).
 *
 * SVG do Font Awesome Free v7.2.0 (viewBox 0 0 640 640). Usa `fill="currentColor"`,
 * herdando a cor do contexto (ex.: `var(--primary)`, branco quando ativo na sidebar).
 *
 * Componente de domínio do Design System Mutual: o símbolo Pix vive AQUI (lib),
 * não nos apps. Para o QR Code use o ícone `QrCode` do lucide-react.
 */
...
export function PixIcon({ size = 16, className, style }: PixIconProps) {
  return (
    <svg
